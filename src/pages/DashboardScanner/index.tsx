...
import DashboardScanner from '../../Components/DashboardScanner/DashboardScanner'
        ...
        <Fragment>
            <Box sx={styles.contPrimary}>
                ...
                <CustomBreadcrumbs paths={[
                    ...
                    { value: 'Codigo de Barras', path: '/module/codigo-de-barras'},
                    { value: 'Estadisticas', path: '/module/codigo-de-barras/dashboard'},
                ]} />
